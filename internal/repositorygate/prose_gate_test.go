...
var bannedKorean = []string{
	"1급", "산다", "죽은", "부여", "봉투", "게이트", "퇴역", "붙은", "가장자리", "이름으로", "말한다", "돈다", "회수",
	"센다", "자리에", "싣는다", "싣고", "두지", "낸다", "답한다", "꽂으면", "나간다", "달고", "흘린다", "흘려보낸",
	"보낸다", "투영", "침묵", "가리킨다", "밝힌다", "안다", "소속은", "고아", "입양", "뺃다", "뺃기", "흉내", "박다",
	"사건", "경계", "무는지", "물어야", "못 박다", "잽니다", "죽이나", "죽이다", "재다", "놓으라",
	"묶임", "진술", "남처럼", "읽힌다", "대가", "비켜서고", "단언", "부재", "잊다",
}
