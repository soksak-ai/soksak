// DOM-lifetime-preserving visibility — switch only visibility of project, content, and view without unmounting.
...
export function applyParked(el: HTMLElement, active: boolean): void {
  ...
  // ancestor can reappear by declaring visible itself, so across the nested project -> space -> tab layers
