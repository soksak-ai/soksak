...
function artifacts(over: { pluginDependencies?: unknown } = {}) {
  ...
  return { rollback, begin, commit, stage, get committed() { return committed; }, value: { begin, stage, readUtf8: async (_: string, handle: string) => handle === "demo" ? JSON.stringify({ id: "demo", name: "Demo", version: "0.0.1", appVersionRequirement: "0.0.1", description: "Demo", permissions: ["sidecar"], runtimeDependencies: pluginDependencies }) : JSON.stringify({ id: "state", version: "0.0.1", interface: [{ id: "soksak-spec-sidecar-state", version: "0.0.1" }], process: "dist/state" }), commit, rollback } };
}
