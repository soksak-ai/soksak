...
export type PluginPermission =
  ...
  | "pty" // spawn a PTY-backed terminal session + IO (flow control + shell env injection — distinct from the raw stdio of process)
...
> = {
  ...
  pty: {
    get label() {
      return tmsg("perm.pty.label");
    },
    get detail() {
      return tmsg("perm.pty.detail");
    },
    caution: true,
  },
  storage: {
