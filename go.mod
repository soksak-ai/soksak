...
require (
	...
	github.com/min-median-max/wails-service-terminal-surface v0.0.0-20260830050450-ec576f927804
	github.com/min-median-max/wails-service-webview-surface v0.0.0-20260829233931-bf938fc3e1d4
