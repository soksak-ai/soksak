...
require (
	...
	github.com/min-median-max/wails-service-terminal-surface v0.0.0-20260829132812-a23d4407978f
...
require (
	...
	github.com/soksak-ai/soksak-contract-surface v0.0.0-20260829090523-321ac93c007d // indirect
