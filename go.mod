...
require (
	...
	github.com/min-median-max/wails-service-native-compositor v0.0.0-20260828174855-6a6f57255a3f
	github.com/min-median-max/wails-service-terminal-surface v0.0.0-20260829025741-cd1e10f6943e
