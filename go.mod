...
require (
	...
	github.com/min-median-max/wails-service-terminal-surface v0.0.0-20260829081450-95c15ed2fd8c
...
require (
	...
	github.com/soksak-ai/soksak-contract-surface v0.0.0-20260829081021-c74bbff0e42d // indirect
