...
require (
	...
	github.com/min-median-max/wails-service-terminal-surface v0.0.0-20260829071000-a28a9fd95e68
...
require (
	...
	github.com/soksak-ai/soksak-contract-surface v0.0.0-20260829065406-d59e685eb8bf // indirect
